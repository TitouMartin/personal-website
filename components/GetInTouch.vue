<template>
    <div class="get-in-touch">
        <div class="button bold white cta-lg">
            Get in touch
...
.get-in-touch {
    ...
    .button {
        ...
        &:before {
            ...
            border-radius: 5px;
            @include get-in-touch-animation-out;
        }
        ...
        .button::before {
            @include get-in-touch-animation;
        }

        .apps {
            @include get-in-touch-apps-animation;
        }
    }
}
